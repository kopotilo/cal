...
var
  ...
  znak : String;
implementation
 Uses Unit1,Unit3,Unit8,Unit9,Unit6;
{$R *.lfm}
 procedure TForm7.ClickBut(Sender: TObject);  // Для кнопок от 0 до 9
begin
...
procedure TForm7.MenuItem8Click(Sender: TObject);
begin
  Unit3.form3.show;
  Unit7.form7.Hide;
end;
...
procedure TForm7.SpeedButton19Click(Sender: TObject);
begin
  Edit1.Clear;
end;

procedure TForm7.SpeedButton20Click(Sender: TObject);
  var
   str: String;
begin
   str := Edit1.Text;
...
procedure TForm7.SpeedButton21Click(Sender: TObject);
begin
...
procedure TForm7.SpeedButton22Click(Sender: TObject);
begin
   a := StrToFloat(Edit1.Text);
  a := sqr(a);
  Edit1.Text:=FloatToStr(a);
...
procedure TForm7.SpeedButton23Click(Sender: TObject);
begin
  a := StrToFloat(Edit1.Text);
  a := sqrt(a);
  Edit1.Text:=FloatToStr(a);
...
procedure TForm7.ClickZnak(Sender: TObject);
begin
   a := StrToFloat(Edit1.Text);
 Edit1.Clear;
